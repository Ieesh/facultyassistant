package assistant.minor2.faculty_assistant.main;
...
import assistant.minor2.faculty_assistant.main.components.About;
import assistant.minor2.faculty_assistant.main.components.GridAdapter;
import assistant.minor2.faculty_assistant.main.components.SettingsActivity;
import assistant.minor2.faculty_assistant.main.database.DatabaseHandler;
...
public class AppBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        basicFields.add("FIND ROOM");
        basicFields.add("SCHEDULER");
        basicFields.add("CR_DETAILS");
