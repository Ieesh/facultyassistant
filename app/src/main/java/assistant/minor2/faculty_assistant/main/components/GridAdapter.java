package assistant.minor2.faculty_assistant.main.components;
...
import assistant.minor2.faculty_assistant.R;
import assistant.minor2.faculty_assistant.main.AppBase;
import assistant.minor2.faculty_assistant.main.findroom.RoomActivity;
import assistant.minor2.faculty_assistant.main.CR_DETAILS.NoteActivity;
import assistant.minor2.faculty_assistant.main.profile.ProfileActivity;
import assistant.minor2.faculty_assistant.main.schedule.Scheduler;
...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if (names.get(position).toString().equals("FIND ROOM")) {
        ...
        } else if (names.get(position).toString().equals("CR_DETAILS")) {
            imageView.setImageResource(R.drawable.ic_attendance);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    .setPositiveButton("Enter", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            if (cursor == null || cursor.getCount() == 0) {
                                Intent launchinIntent = new Intent(AppBase.activity, RoomActivity.class);
