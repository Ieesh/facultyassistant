package assistant.minor2.faculty_assistant.main.profile;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent launchIntent = new Intent(profileActivity, FacultyRegistration.class);
    ...
    public void editStudent(MenuItem item) {
        Intent launchIntent = new Intent(this, EditFacultyActivity.class);
        startActivity(launchIntent);
    }
}
